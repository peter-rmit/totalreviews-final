...
const PrivacyPolicy = () => {
    return (
        <div className="d-flex flex-column flex-1 mt-12 px-5">
            <div className={`card card-custom card-stretch gutter-b p-4 px-10`}>
                <div className="flex-0.2 pb-3">
                    <h1 >Privacy Policy</h1>
                    <p className="text-muted"><strong>In order to receive information about your Personal Data, the purposes and the parties the Data is shared with, contact the Owner.</strong></p>
                </div>
                <hr />
                <div className="flex-0.2 pb-3">
                ...
                <div className="flex-0.2 pb-3">
                    ...
                    <p>The owner does not provide a list of Personal Data types collected.</p><br />
                    <div>
                ...
                <hr />
                <div className="flex-0.2 pb-3">
                    <h3 >Mode and place of processing the Data</h3><br />
                ...
                <div className="flex-0.2 pb-3">
                    ...
                    <ul>
                        ...
                        <li><strong>Verify and seek rectification.</strong> Users have the right, under certain circumstances, to restrict the processing of their Data. In this case, the Owner will not process their Data for any purpose other than storing it.</li>
                        ...
                        <li><strong>Receive their Data and have it transferred to another controller.</strong>{' '}
                ...
                <hr />
                <div className="flex-0.2 pb-3">
                    <p>Latest update: August 04, 2021</p>
                </div>
            </div>
        </div >
    )
