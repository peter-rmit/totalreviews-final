...
const EditModal = ({ show, onHide, newVal, newUser, userId, initials }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: ({ name, companyName, facebookEmail, addressLane1, phone, postcode, city, state, country }, { setStatus, setSubmitting, resetForm }) => {
            enableLoading();
            setTimeout(() => {
                const userData = {
                    name, companyName, facebookEmail, phone, state, city,
