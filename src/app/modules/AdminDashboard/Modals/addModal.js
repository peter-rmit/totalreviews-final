...
const AddModal = ({ show, onHide, newVal, newUser, userId, initials, submitType, heading }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: ({ name, companyName, facebookEmail, password, addressLane1, phone, postcode, city, state, country }, { setStatus, setSubmitting, resetForm }) => {
            enableLoading();
            setTimeout(() => {
                const userData = {
                    name, companyName, facebookEmail, password, phone, state, city,
                    address: addressLane1, country, postcode, userId
                }

                register(userData)
                    .then(async ({ data: { data: { user }, message } }) => {
                        swal({
                            text: message,
                            icon: "success",
                            timer: 2000,
        ...
        >
            ...
            >
                <Modal.Body>
                    ...
                    <div className="form-group">
                        <label className="font-size-h6 font-weight-bolder text-dark">Company Name</label>
                        <input
                            placeholder="Company Name"
                            type="text"
                            value={formik.values.companyName}
                            className={`${formik.touched.companyName && formik.errors.companyName ? 'focus' : ''}
                            form-control h-auto bg-light py-4 px-6 border- rounded-lg font-size-h6 ${getInputClasses(
                                'name'
                            )}`}
                            name="companyName"
                    ...
                    <div className="form-group">
                        <label className="font-size-h6 font-weight-bolder text-dark">Facebook Email</label>
                        <input
                            placeholder="example@me.com"
                            type="text"
                            value={formik.values.facebookEmail}
                            className={`${formik.touched.facebookEmail && formik.errors.facebookEmail ? 'focus' : ''}
                    ...
                    <div className="form-group">
                        ...
                        <textarea
                            ...
                            className={`form-control bg-light h-auto py-4 px-6 border-1 rounded-lg font-size-h6 ${getInputClasses(
                                'addressLane1'
                            )}`}
                            {...formik.getFieldProps('addressLane1')}
                        />
                        {formik.touched.addressLane1 && formik.errors.addressLane1 ? (
                            <div className="fv-plugins-message-container">
                                <div className="fv-help-block error-color">{formik.errors.addressLane1}</div>
                            </div>
                        ) : null}
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className={`${formik.touched.city && formik.errors.city ? 'focus' : ''}
                            form-control h-auto bg-light py-4 px-6 border-1 rounded-lg font-size-h6 ${getInputClasses(
                                'city'
                            )}`}
                            name="city"
                    ...
                    <div className="form-group">
                        <label className="font-size-h6 font-weight-bolder text-dark">Postcode</label>
                        <input
                            placeholder="Postcode"
                            type="text"
                            value={formik.values.postcode}
                            className={`${formik.touched.postcode && formik.errors.postcode ? 'focus' : ''}
                            form-control h-auto bg-light py-4 px-6 border-1 rounded-lg font-size-h6 ${getInputClasses(
                                'postcode'
                            )}`}
                            name="postcode"
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className={`${formik.touched.state && formik.errors.state ? 'focus' : ''}
                            form-control h-auto bg-light py-4 px-6 border-1 rounded-lg font-size-h6 ${getInputClasses(
                                'state'
                            )}`}
                            name="state"
                    ...
                    <div className="form-group">
                        ...
                        <select
                            id="country"
                            name="country"
                            className={`form-control h-auto bg-light py-4 px-6 border-1 rounded-lg font-size-h6 ${getInputClasses(
                                'country'
                            )}`}
                            value={formik.values.country}
                            onChange={formik.handleChange}
                        // className="form-control bg-light h-auto py-4 px-6 border-1 rounded-lg font-size-h6"
                        >
